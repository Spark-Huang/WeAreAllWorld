...
- 部署模式：华为云 CCE Kubernetes 集群托管 OpenClaw 容器。
- 功能：
...
- **ai_partners 表**：由主AI Agent管理，存储AI伙伴信息、记忆点数、性格等
