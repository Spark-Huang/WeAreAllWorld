...
**日期**：2026年2月26日
**更新说明**：
1. 明确子项目定位为云版OpenClaw，主项目是基于OpenClaw构建的元宇宙
2. 补充实用能力增强机制的详细说明
...
│  • 贡献值计算技能（memory-point-calc）                                       │
│  • 实用能力技能（复用OpenClaw内置能力，根据贡献值增强）                        │
└────────────────────────────────────────┬────────────────────────────────────┘
                                          │
                                          ▼
┌─────────────────────────────────────────────────────────────────────────────┐
...
| **数据存储** | Supabase（用户信息、贡献值、剧情进度） | PVC（OpenClaw工作目录、对话历史、长期记忆） |
...
| **游戏配置** | `/app/config/game-config.yml` | 游戏专属配置（贡献值、剧情、里程碑等） |
...
| **贡献值** | Supabase (memory_points表) | 主项目 | 永久 |
